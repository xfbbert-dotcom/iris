...
- [ ] **Step 1: Add container-local runtime-control helpers**
...
- [ ] **Step 2: Reorder backup and cleanup**
...
- [ ] **Step 3: Document the operator-visible semantics**
...
- [ ] **Step 3: Deploy the exact reviewed script**
...
- [ ] **Step 4: Run the disabled-state drill**
...
- [ ] **Step 5: Run the isolated enabled-state drill**
